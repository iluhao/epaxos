...
# some constants
SSHKey=/home/ubuntu/go/src/rabia/deployment/install/id_rsa # RC project has it
EPaxosFolder=/home/ubuntu/go/src/epaxos # where the epaxos' bin folder is located
LogFolder=/home/ubuntu/go/src/epaxos/logs
